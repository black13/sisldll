...
SISLIntpt EXPORT_DLL  *copyIntpt (SISLIntpt * ppt)
#else
SISLIntpt EXPORT_DLL    *
copyIntpt (ppt)
     SISLIntpt *ppt;
#endif
/*
...

#if defined(SISLNEEDPROTOTYPES)
 SISLIntpt  EXPORT_DLL *hp_copyIntpt (SISLIntpt * ppt)
#else
SISLIntpt EXPORT_DLL    *
hp_copyIntpt (ppt)
     SISLIntpt *ppt;
...

#if defined(SISLNEEDPROTOTYPES)
SISLCurve EXPORT_DLL  *newCurve (int in, int ik, double *et, double *ecoef,
	  int ikind, int idim, int icopy)
#else
SISLCurve EXPORT_DLL  *
...

#if defined(SISLNEEDPROTOTYPES)
SISLEdge EXPORT_DLL  *newEdge (int iedge)
#else
SISLEdge EXPORT_DLL  *
newEdge (iedge)
     int iedge;
...

#if defined(SISLNEEDPROTOTYPES)
SISLIntcurve EXPORT_DLL  *newIntcurve (int ipoint, int ipar1, int ipar2,
			   double *epar1, double *epar2, int itype)
#else
SISLIntcurve EXPORT_DLL  *
...

#if defined(SISLNEEDPROTOTYPES)
SISLIntlist EXPORT_DLL  *newIntlist (SISLIntpt * pfirst, SISLIntpt * plast, int itype)
#else
SISLIntlist EXPORT_DLL  *
...

#if defined(SISLNEEDPROTOTYPES)
SISLIntpt EXPORT_DLL  *newIntpt (int ipar, double *epar, double adist)
#else
SISLIntpt EXPORT_DLL  *
...

#if defined(SISLNEEDPROTOTYPES)
SISLIntsurf EXPORT_DLL  *newIntsurf (SISLIntlist * pintlist)
#else
SISLIntsurf EXPORT_DLL  *
newIntsurf (pintlist)
...
#if defined(SISLNEEDPROTOTYPES)
SISLTrimpar EXPORT_DLL  *newTrimpar (int pt, int par)
#else
SISLTrimpar EXPORT_DLL  *
newTrimpar (pt, par)
     int pt;
     int par;
#endif
...

#if defined(SISLNEEDPROTOTYPES)
SISLObject EXPORT_DLL  *newObject (int iobj)
#else
SISLObject EXPORT_DLL  *
newObject (iobj)
     int iobj;
#endif
/*
...

#if defined(SISLNEEDPROTOTYPES)
SISLPoint EXPORT_DLL  *newPoint (double *ecoef, int idim, int icopy)
#else
SISLPoint EXPORT_DLL  *
...

#if defined(SISLNEEDPROTOTYPES)
SISLPtedge EXPORT_DLL  *newPtedge (SISLIntpt * ppt)
#else
SISLPtedge EXPORT_DLL  *
newPtedge (ppt)
     SISLIntpt *ppt;
#endif
/*
...

#if defined(SISLNEEDPROTOTYPES)
SISLCurve EXPORT_DLL  *copyCurve (SISLCurve * pcurve)
#else
SISLCurve EXPORT_DLL  *
copyCurve (pcurve)
     SISLCurve *pcurve;
...

#if defined(SISLNEEDPROTOTYPES)
SISLSurf EXPORT_DLL  *copySurface (SISLSurf * psurf)
#else
SISLSurf EXPORT_DLL  *
copySurface (psurf)
     SISLSurf *psurf;
