...
void EXPORT_DLL  s1859(SISLSurf *ps1,SISLSurf *ps2,double aepsco,double aepsge,
	   int *jpt,double **gpar1,double **gpar2,int *jcrv,
	   SISLIntcurve ***wcurve,int *jstat)
#else
void EXPORT_DLL  s1859(ps1,ps2,aepsco,aepsge,jpt,gpar1,gpar2,jcrv,wcurve,jstat)
     SISLSurf     *ps1;
     SISLSurf     *ps2;    
     double   aepsco;
     double   aepsge;
