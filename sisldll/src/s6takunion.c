...
void EXPORT_DLL  s6takeunion(double evec1[],int ielem1,double evec2[],int ielem2,
		 double **gunion,int *jnmbelem,int *jstat)
#else	 
void EXPORT_DLL  s6takeunion(evec1,ielem1,evec2,ielem2,gunion,jnmbelem,jstat)
