...
void EXPORT_DLL  sh1853(SISLSurf *ps1,double epoint[],double edirec[],double aradius,
...
#else
void EXPORT_DLL  sh1853(ps1,epoint,edirec,aradius,idim,aepsco,aepsge,trackflag,
