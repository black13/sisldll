...
typedef EXPORT_DLL  void (*fparamProc)(double[], int[], int, int, int, double, double *, 
			   double *[], double *[], int *);
typedef EXPORT_DLL  void (*fknotsProc)(double[], int, int, int, double *[], int *);
#else
typedef EXPORT_DLL  void (*fparamProc)();
typedef EXPORT_DLL  void (*fknotsProc)();
#endif
