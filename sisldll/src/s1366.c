...
void EXPORT_DLL  s1366(SISLSurf *ps, double aoffset, double aepsge, double amax, int idim,
	   double *eknot13, int in13, int ik13,
	   double *eknot24, int in24, int ik24,
	   SISLSurf **rs, int *jstat)
#else
void EXPORT_DLL  s1366(ps,aoffset,aepsge,amax,idim,eknot13,in13,ik13,
