...
void EXPORT_DLL  sh1511(SISLSurf *ps,double qpoint[],double bvec[],int idim,double aepsco,
...
#else
void EXPORT_DLL  sh1511(ps, qpoint, bvec, idim, aepsco, aepsge,trackflag,jtrack,
