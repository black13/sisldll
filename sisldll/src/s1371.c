...
void EXPORT_DLL  s1371(SISLCurve *pc1,double ecentr[],double aradiu,int idim,
	   double aepsco,double aepsge,
	   int *jpt,double **gpar,int *jcrv,SISLIntcurve ***wcurve,int *jstat)
#else
void EXPORT_DLL  s1371(pc1,ecentr,aradiu,idim,aepsco,aepsge,jpt,gpar,jcrv,wcurve,jstat)
     SISLCurve    *pc1;
     double   ecentr[];
     double   aradiu;
     int      idim;
