...
typedef EXPORT_DLL  void (*fshapeProc)(double [],double [],int,int,int *);
typedef EXPORT_DLL  void (*initProc)(fshapeProc,SISLCurve *[],int,double [],
			 double [],double [],int *);
#else
typedef EXPORT_DLL  void (*fshapeProc)();
typedef EXPORT_DLL  void (*initProc)();
#endif
...
#else	 
void EXPORT_DLL  sh1461(fshape,f_initmid,vboundc,icurv,vsurf,jstat)
     fshapeProc  fshape;
     initProc    f_initmid;
     SISLCurve   *vboundc[];
     SISLSurf    *vsurf[];
