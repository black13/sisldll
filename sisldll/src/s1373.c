...
void EXPORT_DLL  s1373(SISLCurve *pc1,double etop[],double eaxis[],double econe[],int idim,
	   double aepsco,double aepsge,
	   int *jpt,double **gpar,int *jcrv,SISLIntcurve ***wcurve,int *jstat)
#else
void EXPORT_DLL  s1373(pc1,etop,eaxis,econe,idim,aepsco,aepsge,jpt,gpar,jcrv,wcurve,jstat)
     SISLCurve    *pc1;
     double   etop[];
     double   eaxis[];
     double   econe[];
