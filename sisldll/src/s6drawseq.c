...
extern EXPORT_DLL  void s6move(DOUBLE[]);
extern EXPORT_DLL  void s6line(DOUBLE[]);
#else
extern EXPORT_DLL  void s6move();
extern EXPORT_DLL  void s6line();
#endif

#if defined(SISLNEEDPROTOTYPES)
void EXPORT_DLL 
...
#else
void EXPORT_DLL  s6drawseq(epoint,ipoint)
     double epoint[];
     int ipoint;
#endif
/*
