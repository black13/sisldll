...
void EXPORT_DLL  sh1510(SISLSurf * ps,double eyepoint[],int idim,double aepsco,
...
#else
void EXPORT_DLL  sh1510(ps, eyepoint, idim, aepsco, aepsge,	trackflag,jtrack,wtrack,
