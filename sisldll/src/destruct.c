...
#else
void EXPORT_DLL  freeCurve(pcurve)
     SISLCurve *pcurve;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freeEdge(pedge)
     SISLEdge *pedge;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freeIntcrvlist(viclist,icrv)
...
#else
void EXPORT_DLL  freeIntcurve(pintc)
     SISLIntcurve *pintc;
#endif
...
#else
void EXPORT_DLL  freeIntdat(pintdat)
     SISLIntdat *pintdat;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freeIntlist(plist)
     SISLIntlist *plist;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freeIntsurf(intsurf)
     SISLIntsurf *intsurf;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freeTrimpar(trimpar)
     SISLTrimpar *trimpar;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freeObject(pobj)
     SISLObject *pobj;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freePoint(ppoint)
     SISLPoint *ppoint;
#endif
/*
*********************************************************************
...
#else
void EXPORT_DLL  freeSurf(psurf)
     SISLSurf *psurf;
#endif
/*
*********************************************************************
