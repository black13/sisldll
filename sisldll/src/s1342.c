...
void EXPORT_DLL  s1342(double ep[],double ev[],int im,int idim,int ipar,double epar[],
	   double eeps[],int ilend,int irend,double aepsco,int itmax,
	   SISLCurve **rc,double emxerr[],int *jstat)
#else
void EXPORT_DLL  s1342(ep,ev,im,idim,ipar,epar,eeps,ilend,irend,aepsco,itmax,
           rc,emxerr,jstat)
     double ep[];
     double ev[];
     int    im;
