...

#if defined(SISLNEEDPROTOTYPES)
void EXPORT_DLL  sh1992(SISLObject *po,int itype,double aepsge,int *jstat)
#else
void EXPORT_DLL  sh1992(po,itype,aepsge,jstat)
     SISLObject *po;
     int    itype;
     double aepsge;
     int    *jstat;
...

#if defined(SISLNEEDPROTOTYPES)
void EXPORT_DLL  sh1992cu(SISLCurve *pc,int itype,double aepsge,int *jstat)
#else
void EXPORT_DLL  sh1992cu(pc,itype,aepsge,jstat)
     SISLCurve *pc;
     int   itype;
     double aepsge;
     int   *jstat;
...

#if defined(SISLNEEDPROTOTYPES)
void EXPORT_DLL  sh1992su(SISLSurf *ps,int itype,double aepsge,int *jstat)
#else
void EXPORT_DLL  sh1992su(ps,itype,aepsge,jstat)
     SISLSurf *ps;
     int  itype;
     double aepsge;
     int  *jstat;
